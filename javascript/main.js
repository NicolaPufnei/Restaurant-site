document.getElementById("quatrostagioni").addEventListener("click", function() {
    document.querySelector(".quatro-stagioni-card").classList.add("is-active");
    document.querySelector(".quatro-stagioni").classList.add("is-active");
...
document.getElementById('shadow-background-1').addEventListener("click" , function() {
    document.querySelector(".quatro-stagioni-card").classList.remove("is-active");
